    ...
    public class JunkoDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                ...
                new Product { Id = 3, Name = "iPhone 11 Pro Max 64 GB", Slug = "iphone-11-pro-max-64-gb", BrandProductCategoryId = 1, Price = 2759, Discount = 10, DiscountDate = 10, AdminManagerId = 1, CreatedAt = DateTime.Now, Status = true, FollowCount = 17 },
                ...
                new Product { Id = 10, Name = "APPLE IPAD PRO 10.5 WI-FI 4G 256 GB", Slug = "APPLE-IPAD-PRO-10-5-WI-FI-4G-256-GB", BrandProductCategoryId = 2, Price = 1799, Discount = 0, DiscountDate = 0, AdminManagerId = 1, CreatedAt = DateTime.Now, Status = true, FollowCount = 12 },
                ...
                new Product { Id = 20, Name = "iPhone X Comma Premium Gift", Slug = "iPhone-X-Comma-Premium-Gift", BrandProductCategoryId = 9, Price = 99, Discount = 10, DiscountDate = 5, AdminManagerId = 1, CreatedAt = DateTime.Now, Status = true, FollowCount = 4 },
                ...
                new Product { Id = 27, Name = "Samsung Galaxy Tab S2 VE 8.0", Slug = "Samsung-Galaxy-Tab-S2-VE-8-0", BrandProductCategoryId = 11, Price = 799, Discount = 10, DiscountDate = 5, AdminManagerId = 1, CreatedAt = DateTime.Now, Status = true, FollowCount = 15 },
            ...
            modelBuilder.Entity<ProperityProduct>().HasData(
                ...
                new ProperityProduct { Id = 3, ProductId = 1, ProperityId = 3, Key = "Single SIM  or Dual SIM", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 4, ProductId = 1, ProperityId = 4, Key = "iOS 13, upgradable to iOS 13.1", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 5, ProductId = 1, ProperityId = 5, Key = "Apple A13 Bionic (7 nm+)", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 6, ProductId = 1, ProperityId = 6, Key = "Hexa-core (2x2.65 GHz Lightning + 4x1.8 GHz Thunder)", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 7, ProductId = 1, ProperityId = 7, Key = "256 GB", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 8, ProductId = 1, ProperityId = 8, Key = "4 GB RAM", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 9, ProductId = 1, ProperityId = 9, Key = "-", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 10, ProductId = 1, ProperityId = 10, Key = "12 MP, f/1.8, 26mm (wide), 1/2.55", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 11, ProductId = 1, ProperityId = 11, Key = "2160p@24/30/60fps, 1080p@30/60/120/240fps, HDR, stereo sound rec.", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 12, ProductId = 1, ProperityId = 12, Key = "12 MP, f/2.2 TOF 3D camera", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 13, ProductId = 1, ProperityId = 13, Key = "Wi-Fi 802.11 a/b/g/n/ac/ax, dual-band, hotspot", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 14, ProductId = 1, ProperityId = 14, Key = "5.0, A2DP, LE", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 15, ProductId = 1, ProperityId = 15, Key = "Non-removable Li-Ion 3969 mAh battery (15.04 Wh)", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 16, ProductId = 16, ProperityId = 5, Key = "Intel Core i7,2.6Ghz", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 17, ProductId = 16, ProperityId = 7, Key = "512 GB SSD", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 18, ProductId = 16, ProperityId = 8, Key = "16 GB", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 19, ProductId = 16, ProperityId = 31, Key = "USB, HDMI, VGA", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 20, ProductId = 16, ProperityId = 32, Key = "Wi-Fi / LAN / BT", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 21, ProductId = 34, ProperityId = 16, Key = "65(164 sm)", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 22, ProductId = 34, ProperityId = 34, Key = "LED", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 23, ProductId = 34, ProperityId = 35, Key = "100 Hz", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 24, ProductId = 34, ProperityId = 36, Key = "+", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 25, ProductId = 34, ProperityId = 37, Key = "USB, HDMI", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 26, ProductId = 34, ProperityId = 38, Key = "+", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 27, ProductId = 34, ProperityId = 39, Key = "-", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 28, ProductId = 34, ProperityId = 40, Key = "AVI, DivX, MKV, MPEG4,MP3,WMA,JPEG", CreatedAt = DateTime.Now },
                new ProperityProduct { Id = 29, ProductId = 34, ProperityId = 1, Key = "1452.7 x 918.1 x 312.8 mm", CreatedAt = DateTime.Now }
                );
